    ...
    return (
      <main>
        <header>
          ...
          <h2>Annotation:</h2>
          <p>
            This app either shows list of people, or a query's cached value while it's loading.
          </p>
          <p>
            The bug is that if you switch to a page which should show the query results with different variables,
            but it hasn't been cached once, it actually shows cached value from a "previous" (query-variables) pair.
          </p>
          <p>
